...
demo |>
  ...
  ggplot(aes(x = age, y = education, color = education)) +
  geom_density_ridges(scale = 0.6, alpha = 0.5) +
  facet_grid(. ~ sex)
  
```
* Compared to males, female participants have lower proportion of high school equivalent education; People with more than high school education ar more likely to get involved in this study.
* Overall, male participants have higher heterogeneity in age across all educational level, especially among less than and equal high school education level compared with females. Age distribution is more sparse in more than high school education level compared with other two education levels bot for males and females.
...
* generally, the overall activity over the course of the day of participants decreases as their age become older. The effect of age on total activity is mitigated among the more than high school education level.  
